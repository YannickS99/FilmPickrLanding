...
const translations = {
    en: {
        ...
        "cta.main": "Download on the App Store",
        ...
        "faq.a4": "FilmPickr is completely free – no subscription, no hidden costs and no in-app purchases. The app is available now on the App Store.",
        "download.title": "Available now.",
        "download.desc": "FilmPickr is available now on the App Store. Make your next movie night an experience.",
    ...
    de: {
        ...
        "faq.a4": "FilmPickr steht komplett kostenlos zur Verfügung – ohne Abo, ohne versteckte Kosten und ohne In-App-Käufe. Die App ist ab sofort im App Store erhältlich.",
        "download.title": "Jetzt verfügbar.",
        "download.desc": "FilmPickr ist ab sofort im App Store. Macht euren nächsten Filmabend zum Erlebnis.",
